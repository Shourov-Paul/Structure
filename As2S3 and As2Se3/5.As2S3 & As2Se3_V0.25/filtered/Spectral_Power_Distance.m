...
aeff_R2    = 9.98366788374865E-12; % Aeff for R = 2.00 um (Column 1)
aeff_R2_25 = 1.17744109054571E-11; % Aeff for R = 2.25 um (Column 2)
aeff_R2_5  = 1.37815146431401E-11; % Aeff for R = 2.50 um (Column 3)
aeff_R2_75 = 1.601243459682E-11; % Aeff for R = 2.75 um (Column 4)
...
csv_path = fullfile(fileparts(mfilename('fullpath')), 'all_n_H0.25.csv');
