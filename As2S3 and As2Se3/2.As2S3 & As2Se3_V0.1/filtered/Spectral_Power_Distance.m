...
aeff_R2    = 9.61184522283068E-12; % Aeff for R = 2.00 um (Column 1)
aeff_R2_25 = 1.1476955157718E-11; % Aeff for R = 2.25 um (Column 2)
aeff_R2_5  = 1.35496117883243E-11; % Aeff for R = 2.50 um (Column 3)
aeff_R2_75 = 1.58237193103299E-11; % Aeff for R = 2.75 um (Column 4)
...
csv_path = fullfile(fileparts(mfilename('fullpath')), 'all_n_H0.1.csv');
