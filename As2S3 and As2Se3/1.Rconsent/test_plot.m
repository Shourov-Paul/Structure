...
radius_labels = {'H = 0.05 um', 'H = 0.1 um', 'H = 0.15 um'};
...
% 3. Legend and Text
legend([h1, h2, h3], 'H = 0.05 \mum', 'H = 0.1 \mum', 'H = 0.15 \mum', ...
    'FontSize', 18, 'FontWeight', 'bold', 'FontAngle', 'italic', 'Location', 'southeast');
legend('boxoff');

text(2.6, 40, 'R = 2.5 \mum', 'FontSize', 18, 'FontWeight', 'bold', 'FontAngle', 'italic');
hold off;

% Save the plot
output_image_path = fullfile(fileparts(mfilename('fullpath')), 'Dispersion.png');
